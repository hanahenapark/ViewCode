// Question 42. Given two line segments [P0, P1] and [P1, P2], 
//if we traverse [P0, P1] and then [P1, P2], do we make a left turn at point P1?
...
// Test case example 2:
// [P0, P1, P2]: [(66, 50), (12, 35), (17, 96)]
// Output: False

//Cross Product  (p2 - p0) X (p1 - p0)
// + right, lock-wise, right
...
/*
//return (Pk-Pi) X (Pj-Pi) = (p2 - p0) x (p1 - p0)
...
int main(){
    ...
    if(Dir(p0x,p0y,p1x,p1y,p2x,p2y)>0){
        cout<<"FALSE\n";
    }
    else if(Dir(p0x,p0y,p1x,p1y,p2x,p2y)<0){
        cout<<"TRUE\n";
    }
    else
    {
